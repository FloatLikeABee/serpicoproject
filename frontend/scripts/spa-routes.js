...
const routes = ['x-hard-data', 'x-hard-data/hw', 'login', 'fridge-raid', 'lalem', 'shuileme', 'shuileme/chat', 'kuaixiaosan', 'kuaixiaosan/chat', 'xiaomaomi'];
...
// Keep 404.html as a last-resort SPA shell (status may still be 404).
